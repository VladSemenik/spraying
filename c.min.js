...
!(function(A, e) {
  ...
  return (function(A) {
    ...
    function(A, e, t) {
      ...
      var r = (function() {
        ...
        n = function(A, e) {
          ...
          if (Symbol.iterator in Object(A))
            return (function(A, e) {
              ...
              try {
                for (
                  var s, o = A[Symbol.iterator]();
                  !(r = (s = o.next()).done) && (t.push(s.value), !e || t.length !== e);
                  r = !0
                );
              } catch (A) {
                (n = !0), (B = A);
        ...
        G = function(A, e, t, r, n) {
          ...
          if ((a === H && -1 !== [N, p, K].indexOf(D)) || (-1 !== [N, p, K].indexOf(a) && D === d))
            return T;
          if (
            (-1 !== z.indexOf(a) && -1 !== x.indexOf(D)) ||
            (-1 !== x.indexOf(a) && -1 !== z.indexOf(D))
          )
            return T;
          if (
            (-1 !== [H, d].indexOf(a) &&
              (D === h || (-1 !== [F, Q].indexOf(D) && e[o + 1] === h))) ||
            (-1 !== [F, Q].indexOf(a) && D === h) ||
            (a === h && -1 !== [h, f, C].indexOf(D))
          )
            return T;
          ...
          if (
            (y === a && -1 !== [y, v, m, b].indexOf(D)) ||
            (-1 !== [v, m].indexOf(a) && -1 !== [v, I].indexOf(D)) ||
            (-1 !== [I, b].indexOf(a) && D === I)
          )
            return T;
          if ((-1 !== k.indexOf(a) && -1 !== [U, d].indexOf(D)) || (-1 !== k.indexOf(D) && a === H))
            return T;
          if (-1 !== z.indexOf(a) && -1 !== z.indexOf(D)) return T;
          if (a === C && -1 !== z.indexOf(D)) return T;
          if (
            (-1 !== z.concat(h).indexOf(a) && D === F) ||
            (-1 !== z.concat(h).indexOf(D) && a === w)
          )
            return T;
          if (41 === a && 41 === D) {
                ...
                value: function(A) {
                  ...
                  if (A >= 0) {
                    if (A < 55296 || (A > 56319 && A <= 65535))
                      return (e = ((e = this.index[A >> B]) << o) + (A & Q)), this.data[e];
                    if (A <= 65535)
                      return (
                        (e = ((e = this.index[i + ((A - 55296) >> B)]) << o) + (A & Q)),
                        this.data[e]
                      );
                    if (A < this.highStart)
                      return (
    ...
    function(A, e, t) {
      'use strict';
      t.r(e);
      var r = { VECTOR: 0, BEZIER_CURVE: 1, CIRCLE: 2 };
      function n(A, e) {
        for (var t = 0; t < e.length; t++) {
          var r = e[t];
          (r.enumerable = r.enumerable || !1),
        ...
        U = (function() {
          function A(e) {
            ...
            var t = (function(A, e) {
                ...
                Array.isArray(e) ? w(e) : s(e) || c(e) || l(e) || u(e) || a(e) || [0, 0, 0, null],
                4
              ),
              r = t[0],
              n = t[1],
                  ...
                  (this.ctx = this.canvas.getContext('2d')),
                    ...
                    A.logger.log(
                      'Canvas renderer initialized ('
                        ...
                        .concat(A.height, ' at ')
                        .concat(A.x, ',')
                        .concat(A.y, ') with scale ')
                        .concat(this.options.scale)
                    );
                },
              },
              {
              ...
              },
              {
                ...
                value: function(A, e) {
                  ...
                  return (
                    ...
                    t
                      .getContext('2d')
                      .drawImage(A, 0, 0, A.width, A.height, 0, 0, e.width, e.height),
                    t
                  );
                },
              },
                    ...
                    Function.prototype.bind
                      ...
                      .apply(
                        ...
                        [
                          ...
                          this.id ? 'html2canvas ('.concat(this.id, '):') : 'html2canvas:',
      ...
      var y = { PX: 0, PERCENTAGE: 1 },
        v = (function() {
          function A(e) {
            !(function(A, e) {
              if (!(A instanceof e)) throw new TypeError('Cannot call a class as a function');
            })(this, A),
              (this.type = '%' === e.substr(e.length - 1) ? y.PERCENTAGE : y.PX);
            var t = parseFloat(e);
      ...
      var L = (function() {
        ...
        V = function(A, e, t, r) {
          var n = [];
          return (
            A instanceof X ? n.push(A.subdivide(0.5, !1)) : n.push(A),
            t instanceof X ? n.push(t.subdivide(0.5, !0)) : n.push(t),
            r instanceof X ? n.push(r.subdivide(0.5, !0).reverse()) : n.push(r),
            e instanceof X ? n.push(e.subdivide(0.5, !1).reverse()) : n.push(e),
            n
          );
        },
        k = function(A) {
        ...
        J = function(A, e, t) {
          ...
          return {
            topLeftOuter:
              r > 0 || n > 0 ? _(A.left, A.top, r, n, R.TOP_LEFT) : new M(A.left, A.top),
            topLeftInner:
              r > 0 || n > 0
                ? _(
                ...
                : new M(A.left + e[3].borderWidth, A.top + e[0].borderWidth),
            topRightOuter:
              B > 0 || s > 0
                ? _(A.left + w, A.top, B, s, R.TOP_RIGHT)
                : new M(A.left + A.width, A.top),
            topRightInner:
              B > 0 || s > 0
                ? _(
                    A.left + Math.min(w, A.width + e[3].borderWidth),
                    A.top + e[0].borderWidth,
                    w > A.width + e[3].borderWidth ? 0 : B - e[3].borderWidth,
                    s - e[0].borderWidth,
                    R.TOP_RIGHT
                  )
                : new M(A.left + A.width - e[1].borderWidth, A.top + e[0].borderWidth),
            bottomRightOuter:
              o > 0 || a > 0
                ? _(A.left + U, A.top + u, o, a, R.BOTTOM_RIGHT)
                : new M(A.left + A.width, A.top + A.height),
            bottomRightInner:
              o > 0 || a > 0
                ? _(
                    A.left + Math.min(U, A.width - e[3].borderWidth),
                    A.top + Math.min(u, A.height + e[0].borderWidth),
                    Math.max(0, o - e[1].borderWidth),
                    a - e[2].borderWidth,
                    R.BOTTOM_RIGHT
                  )
                : new M(A.left + A.width - e[1].borderWidth, A.top + A.height - e[2].borderWidth),
            bottomLeftOuter:
              i > 0 || c > 0
                ? _(A.left, A.top + g, i, c, R.BOTTOM_LEFT)
                : new M(A.left, A.top + A.height),
            bottomLeftInner:
              i > 0 || c > 0
                ? _(
                    A.left + e[3].borderWidth,
                    A.top + g,
                    Math.max(0, i - e[3].borderWidth),
                    c - e[2].borderWidth,
                    R.BOTTOM_LEFT
                  )
                : new M(A.left + e[3].borderWidth, A.top + A.height - e[2].borderWidth),
          };
        },
        R = { TOP_LEFT: 0, TOP_RIGHT: 1, BOTTOM_RIGHT: 2, BOTTOM_LEFT: 3 },
        ...
        W = { BORDER_BOX: 0, PADDING_BOX: 1, CONTENT_BOX: 2 },
        Y = W,
        q = function A(e) {
          switch (
            ((function(A, e) {
        ...
        oA = Object.keys({ TOP: 0, RIGHT: 1, BOTTOM: 2, LEFT: 3 }).map(function(A) {
      ...
      var iA = ['top-left', 'top-right', 'bottom-right', 'bottom-left'],
        cA = function(A) {
          return iA.map(function(e) {
            var t = (function(A, e) {
                ...
                A.getPropertyValue('border-'.concat(e, '-radius'))
                  .split(' ')
                  .map(v.create),
                2
              ),
        ...
        EA = { VISIBLE: 0, HIDDEN: 1, SCROLL: 2, AUTO: 3 },
        pA = function(A) {
          switch (A) {
            case 'hidden':
              return EA.HIDDEN;
        ...
        mA = { STATIC: 0, RELATIVE: 1, ABSOLUTE: 2, FIXED: 3, STICKY: 4 },
        bA = function(A) {
          switch (A) {
            case 'relative':
              return mA.RELATIVE;
          ...
          for (
            var e = '',
              ...
              a = function() {
                r.length &&
                  null !== s &&
                  n.push({ color: s, offsetX: r[0] || 0, offsetY: r[1] || 0, blur: r[2] || 0 }),
                  r.splice(0, r.length),
                  (s = null);
              },
              i = 0;
        ...
        MA = function(A) {
          var e = SA(
            A.transform || A.webkitTransform || A.mozTransform || A.msTransform || A.oTransform
          );
          return null === e
            ? null
            : {
      ...
      var xA = (function() {
        ...
        kA = function(A) {
          return new Promise(function(e, t) {
            ...
            (r.onload = function() {
              ...
              (r.onerror = t),
              (r.src = 'data:image/svg+xml;charset=utf-8,'.concat(
                    ...
                    return (
                      ...
                      kA(B)
                        .then(function(e) {
                          ...
                          return (
                            (B.style.backgroundImage = 'url('.concat(n, ')')),
                            (B.style.height = ''.concat(100, 'px')),
                            JA(r) ? kA(VA(100, 100, 0, 0, B)) : Promise.reject(!1)
                          );
                        })
                        .then(function(A) {
        ...
        YA = function(A, e, t, r, n) {
          ...
          return (
            B.setStart(A, e), B.setEnd(A, e + t), L.fromClientRect(B.getBoundingClientRect(), r, n)
          );
        };
      function qA(A, e) {
        for (var t = 0; t < e.length; t++) {
                      ...
                      for (
                        var r =
                            0 !== e.style.letterSpacing
                              ? Object(PA.toCodePoints)(A).map(function(A) {
                                  return Object(PA.fromCodePoint)(A);
                                })
                              : (function(A, e) {
                                  for (
                                    var t,
                                      r = Object(PA.LineBreaker)(A, {
                                        lineBreak: e.style.lineBreak,
                                        wordBreak:
                                          1 === e.style.overflowWrap
                                            ? 'break-word'
                                            : e.style.wordBreak,
                                      }),
                                      n = [];
      ...
      var ee = function A(e, t, n) {
        ...
        Be = { borderWidth: 1, borderColor: re, borderStyle: 1 },
        se = [Be, Be, Be, Be],
        oe = {
          backgroundColor: ne,
          backgroundImage: [],
          ...
          if ('radio' === A.type || 'checkbox' === A.type) {
            if (A.checked) {
              ...
              e.childNodes.push(
                'checkbox' === A.type
                  ? [
                      new M(e.bounds.left + 0.39363 * t, e.bounds.top + 0.79 * t),
                      new M(e.bounds.left + 0.16 * t, e.bounds.top + 0.5549 * t),
                      new M(e.bounds.left + 0.27347 * t, e.bounds.top + 0.44071 * t),
                      new M(e.bounds.left + 0.39694 * t, e.bounds.top + 0.5649 * t),
                      new M(e.bounds.left + 0.72983 * t, e.bounds.top + 0.23 * t),
                      new M(e.bounds.left + 0.84 * t, e.bounds.top + 0.34085 * t),
                      new M(e.bounds.left + 0.39363 * t, e.bounds.top + 0.79 * t),
                    ]
                  : new ee(e.bounds.left + t / 4, e.bounds.top + t / 4, t / 4)
              );
            }
          } else he(de(A), A, e, !1);
        },
        ...
        he = function(A, e, t, r) {
          ...
          if (A.length > 0 && n) {
            ...
            b(e.ownerDocument.defaultView.getComputedStyle(e, null), B),
              (B.style.position = 'absolute'),
              (B.style.left = ''.concat(t.bounds.left, 'px')),
              (B.style.top = ''.concat(t.bounds.top, 'px')),
              r || (B.style.whiteSpace = 'nowrap');
            var s = e.ownerDocument.createTextNode(A);
            B.appendChild(s),
              n.appendChild(B),
              t.childNodes.push(jA.fromTextNode(s, t)),
              n.removeChild(B);
          }
        },
        de = function(A) {
        ...
        Ee = function(A, e, t) {
          ...
          if (r) {
            var n,
              B = A.ownerDocument.defaultView.getComputedStyle(A, null),
            ...
            switch (
              ...
              case 0:
                (s.style.left = ''.concat(
                  e.bounds.left - e.style.margin[3].getAbsoluteValue(e.bounds.width),
                  'px'
                )),
                  (s.style.right = 'auto'),
            ...
            if (a)
              if ('url' === a.method) {
                ...
                (i.src = a.args[0]),
                  (s.style.top = ''.concat(e.bounds.top - o, 'px')),
                  (s.style.width = 'auto'),
                  (s.style.height = 'auto'),
                  s.appendChild(i);
              } else {
                var c = 0.5 * parseFloat(e.style.font.fontSize);
                (s.style.top = ''.concat(e.bounds.top - o + e.bounds.height - 1.5 * c, 'px')),
                  (s.style.width = ''.concat(c, 'px')),
                  (s.style.height = ''.concat(c, 'px')),
                  (s.style.backgroundImage = B.listStyleImage);
              }
            else
              'number' == typeof e.listIndex &&
                ((n = A.ownerDocument.createTextNode(Me(e.listIndex, r.listStyleType, !0))),
                s.appendChild(n),
                (s.style.top = ''.concat(e.bounds.top - o, 'px')));
            var Q = A.ownerDocument.body;
            Q.appendChild(s),
              n
                ? (e.childNodes.push(jA.fromTextNode(n, e)), Q.removeChild(s))
                : e.childNodes.push(new Xe(s, e, t, 0));
          }
        },
        pe = {
      ...
      var Se = ['INPUT', 'TEXTAREA', 'SELECT'],
          ...
          function A(e, t, r, n) {
            ...
            if (
              ((this.style = {
                ...
                border: Q ? se : aA(i),
                borderRadius:
                  (e instanceof s.HTMLInputElement || e instanceof HTMLInputElement) && Q
                    ? ue(e)
                    : cA(i),
              ...
              if (w) {
                ...
                w.listItems.push(this),
                  (this.listIndex =
                    e.hasAttribute('value') && 'number' == typeof e.value
                      ? e.value
                      : 0 === u
                      ? 'number' == typeof w.listStart
                        ? w.listStart
                        : 1
                      : w.listItems[u - 1].listIndex + 1);
              }
            }
            'IMG' === e.tagName &&
              e.addEventListener('load', function() {
                (B.bounds = O(e, o, a)),
                  (B.curvedBounds = J(B.bounds, B.style.border, B.style.borderRadius));
              }),
              (this.image = ze(e, r)),
              (this.bounds = Q ? Ce(O(e, o, a)) : O(e, o, a)),
              (this.curvedBounds = J(this.bounds, this.style.border, this.style.borderRadius));
          }
          return (
            (function(A, e, t) {
              e && Te(A.prototype, e);
              ...
              },
              {
                ...
                value: function() {
                  return (
                    this.isRootElement() && !this.isFloating() && !this.isAbsolutelyPositioned()
                  );
                },
              },
              {
                ...
                value: function() {
                  return (
                    !K(this.style.display, QA.NONE) &&
                    this.style.opacity > 0 &&
                    0 === this.style.visibility
                  );
                },
              },
              {
              ...
              },
              {
                ...
                value: function() {
                  return (
                    K(this.style.display, QA.INLINE) ||
                    K(this.style.display, QA.INLINE_BLOCK) ||
                    K(this.style.display, QA.INLINE_FLEX) ||
                    K(this.style.display, QA.INLINE_GRID) ||
                    K(this.style.display, QA.INLINE_LIST_ITEM) ||
                    K(this.style.display, QA.INLINE_TABLE)
                  );
                },
              },
              {
                ...
                value: function() {
                  return (
                    K(this.style.display, QA.INLINE_BLOCK) || K(this.style.display, QA.INLINE_TABLE)
                  );
                },
              },
            ]),
        ...
        ze = function(A, e) {
          if (
            ...
            return e.loadImage(
              'data:image/svg+xml,'.concat(encodeURIComponent(t.serializeToString(A)))
            );
          }
          switch (A.tagName) {
            case 'IMG':
            ...
            (function(A, e, t) {
            ...
            })(A, [
              {
                ...
                value: function(A) {
                  ...
                  return n.removeChild(e), { baseline: B, middle: s };
                },
              },
              {
                key: 'getMetrics',
                value: function(A) {
                  ...
                  return (
                    void 0 === this._data[e] && (this._data[e] = this._parseMetrics(A)),
                    this._data[e]
                  );
                },
              },
      ...
      var We = /^(to )?(left|top|right|bottom)( (left|top|right|bottom))?$/i,
        ...
        At = function(A, e, t) {
          for (var r = [], n = e; n < A.length; n++) {
            var B = A[n],
              ...
              i = s
                ? new v(B.substring(o + 1))
                : n === e
                ? new v('0%')
                : n === A.length - 1
                ? new v('100%')
                : null;
            r.push({ color: a, stop: i });
          }
          for (
        ...
        et = function(A, e, t) {
          var r = (function(A) {
            ...
            o = B ? 1 : 0,
            a = Math.min(
              m(Math.abs(s.x0) + Math.abs(s.x1), Math.abs(s.y0) + Math.abs(s.y1)),
              2 * e.width,
              2 * e.height
            );
        ...
        tt = function(A, e, t) {
          var r = e[0].match(Ze),
            ...
            s = {};
          r &&
            (void 0 !== r[3] && (B.x = I(A, r[3], r[4]).getAbsoluteValue(t.width)),
            void 0 !== r[5] && (B.y = I(A, r[5], r[6]).getAbsoluteValue(t.height)),
            r[7] ? (s.x = $e[r[7].toLowerCase()]) : void 0 !== r[8] && (s.x = I(A, r[8], r[9])),
            r[10]
              ? (s.y = $e[r[10].toLowerCase()])
              : void 0 !== r[11] && (s.y = I(A, r[11], r[12])));
          var o = {
        ...
        rt = function(A, e) {
          var t = e.width,
            ...
            o = n + Math.sin(A) * s,
            a = B - Math.cos(A) * s;
          return { x0: o, x1: t - o, y0: a, y1: r - a };
        },
        nt = function(A) {
            ...
            case 'closest-side':
              0 === e
                ...
                : 1 === e &&
                  ...
                  (a = Math.min(Math.abs(s), Math.abs(s - n.height))));
              break;
            case 'closest-corner':
              if (0 === e)
                o = a = Math.min(
            ...
            case 'farthest-side':
              0 === e
                ...
                : 1 === e &&
                  ...
                  (a = Math.max(Math.abs(s), Math.abs(s - n.height))));
              break;
        ...
        ct = function(A) {
          return A.map(function(A) {
            ...
            switch (e[1]) {
              ...
              case 'color-stop':
                return '%' === e[3]
                  ? ''.concat(e[4], ' ').concat(e[2])
                  : ''.concat(e[4], ' ').concat(100 * parseFloat(e[2]), '%');
            }
          });
        };
      function Qt(A, e) {
      ...
      var wt = (function() {
                    ...
                    t = function() {
                      if (
                        ...
                        if (t) {
                          ...
                          n > 0 &&
                            B > 0 &&
                            e.target.clip([k(A.curvedBounds)], function() {
                    ...
                    var r = Z(
                      ...
                      n = (function(A, e, t) {
                        ...
                        if (1 === B[0].size || 2 === B[0].size) {
                          var s = t.width / t.height,
                            o = e.width / e.height;
                          return s < o != (2 === B[0].size)
                            ? new D(t.width, t.width / o)
                            : new D(t.height * o, t.height);
                        }
                        return (
                          B[0].value && (r = B[0].value.getAbsoluteValue(t.width)),
                          0 === B[0].size && 0 === B[1].size
                            ? (n = e.height)
                            : 0 === B[1].size
                            ? (n = (r / e.width) * e.height)
                            : B[1].value && (n = B[1].value.getAbsoluteValue(t.height)),
                          0 === B[0].size && (r = (n / e.height) * e.width),
                          new D(r, n)
                        );
                      })(e, t, r),
                      B = $(e.position, n, r),
                      s = (function(A, e, t, r, n) {
                        switch (A.repeat) {
                          case 2:
                            return [
                              new M(Math.round(n.left), Math.round(r.top + e.y)),
                              new M(Math.round(n.left + n.width), Math.round(r.top + e.y)),
                              new M(
                                Math.round(n.left + n.width),
                                Math.round(t.height + r.top + e.y)
                              ),
                              new M(Math.round(n.left), Math.round(t.height + r.top + e.y)),
                            ];
                          case 3:
                            return [
                              new M(Math.round(r.left + e.x), Math.round(n.top)),
                              new M(Math.round(r.left + e.x + t.width), Math.round(n.top)),
                              new M(
                                Math.round(r.left + e.x + t.width),
                                Math.round(n.height + n.top)
                              ),
                              new M(Math.round(r.left + e.x), Math.round(n.height + n.top)),
                            ];
                          case 1:
                            return [
                              new M(Math.round(r.left + e.x), Math.round(r.top + e.y)),
                              new M(Math.round(r.left + e.x + t.width), Math.round(r.top + e.y)),
                              new M(
                                Math.round(r.left + e.x + t.width),
                                Math.round(r.top + e.y + t.height)
                              ),
                              new M(Math.round(r.left + e.x), Math.round(r.top + e.y + t.height)),
                            ];
                          default:
                            return [
                              new M(Math.round(n.left), Math.round(n.top)),
                              new M(Math.round(n.left + n.width), Math.round(n.top)),
                              new M(Math.round(n.left + n.width), Math.round(n.height + n.top)),
                              new M(Math.round(n.left), Math.round(n.height + n.top)),
                            ];
                        }
                      })(e, B, n, r, A.bounds),
                  ...
                  var t = Z(
                    ...
                    s = (function(A, e, t) {
                      ...
                      return 'linear-gradient' === n
                        ...
                        ? et(['to bottom'].concat(ct(r.slice(3))), t, !!B)
                        : 'radial-gradient' === n
                        ? tt(A, '-webkit-' === B ? it(r) : r, t)
                        : 'gradient' === n && 'radial' === r[0]
                        ? tt(A, ct(it(r.slice(1))), t)
                        : void 0;
                    })(A, e.source, B);
                  if (s)
                    switch (s.type) {
              ...
              },
              {
                ...
                value: function(A) {
                  ...
                  this.renderNodeBackgroundAndBorders(A.container),
                    t.sort(gt).forEach(this.renderStack, this),
                    this.renderNodeContent(A.container),
                    i.forEach(this.renderNode, this),
                    B.forEach(this.renderStack, this),
                    s.forEach(this.renderStack, this),
                    a.forEach(this.renderNode, this),
        ...
        Ut = function(A) {
          for (
            var e = [], t = [], r = [], n = [], B = [], s = A.contexts.length, o = 0;
            o < s;
            o++
          ) {
            var a = A.contexts[o];
            ...
            dt(A, [
              {
                ...
                value: function(A) {
                  ...
                  if (!yt(A) || _A.SUPPORT_SVG_DRAWING) {
                    if (!0 === this.options.allowTaint || mt(A) || this.isSameOrigin(A))
                      return this.addImage(A, A, !1);
                    if (!this.isSameOrigin(A)) {
                      if ('string' == typeof this.options.proxy)
                        return (
                          (this.cache[A] = Ft(A, this.options).then(function(A) {
                            return vt(A, e.options.imageTimeout || 0);
                          })),
                          A
                        );
                      if (!0 === this.options.useCORS && _A.SUPPORT_CORS_IMAGES)
              ...
              },
              {
                ...
                value: function(A) {
                  var e = this;
                  return mt(A)
                    ? vt(A, this.options.imageTimeout || 0)
                            ...
                            if (200 !== n.status)
                              r(
                                'Failed to fetch image '
                                  .concat(A.substring(0, 256), ' with status code ')
                                  .concat(n.status)
                              );
                            else {
              ...
              },
              {
                ...
                value: function(A, e, t) {
                  var r = this;
                  return (
                    (this.cache[A] = new Promise(function(A, n) {
                      var B = new Image();
                      if (
                        ((B.onload = function() {
                          return A(B);
                        }),
                        (bt(e) || t) && (B.crossOrigin = 'anonymous'),
                        (B.onerror = n),
                        (B.src = e),
                        !0 === B.complete &&
                          setTimeout(function() {
      ...
      var Dt = function(A, e, t) {
          ...
          for (var l = 0; l < n; l++) {
            ...
            switch (w.type) {
              ...
              case 6:
                ...
                break;
              case 2:
                s && (B.push({ type: 0, value: s }), (s = '')),
                  B.push({ type: 1, value: w.value || '' });
            }
          }
          return s && B.push({ type: 0, value: s }), B;
        },
        Mt = function(A, e) {
          if (e && e[A]) return e[A];
          for (
            var t = [], r = A.length, n = !1, B = !1, s = !1, o = '', a = '', i = [], c = 0;
            c < r;
            c++
          ) {
            var Q = A.charAt(c);
            switch (Q) {
              case "'":
              case '"':
                B ? (o += Q) : ((n = !n), s || n || (t.push({ type: 0, value: o }), (o = '')));
                break;
              case '\\':
                B ? ((o += Q), (B = !1)) : (B = !0);
                break;
              ...
              case ')':
                if (n) o += Q;
                  ...
                  switch ((o && i.push(o), a)) {
                    case 'attr':
                      i.length > 0 && t.push({ type: 1, value: i[0] });
                      break;
                    case 'counter':
                      if (i.length > 0) {
                        var l = { type: 3, name: i[0] };
                        i.length > 1 && (l.format = i[1]), t.push(l);
                      }
                      break;
                    case 'counters':
                      if (i.length > 0) {
                        var w = { type: 4, name: i[0] };
                        i.length > 1 && (w.glue = i[1]),
                          i.length > 2 && (w.format = i[2]),
                          t.push(w);
                      }
                      break;
                    case 'url':
                      i.length > 0 && t.push({ type: 2, value: i[0] });
                  }
                  (s = !1), (o = '');
                }
                break;
        ...
        Xt = function(A, e, t) {
          for (var r = A.length, n = '', B = 0; B < r; B++)
            B > 0 && (n += e || ''), (n += Me(A[B], CA(t || 'decimal'), !1));
          return n;
        };
      function zt(A, e) {
        for (var t = 0; t < e.length; t++) {
      ...
      var Lt = (function() {
          function A(e, t, r, n, B) {
            !(function(A, e) {
              ...
              (this.options = t),
              (this.renderer = B),
              (this.resourceLoader = new Ht(t, r, window)),
            ...
            })(A, [
              {
                ...
                value: function(A) {
                  ...
                  if (this.inlineImages && A) {
                    var t = A.style;
                    Promise.all(
                      sA(t.backgroundImage).map(function(A) {
                        return 'url' === A.method
                          ? e.resourceLoader
                      ...
                      return Promise.all(
                        A.map(function(A) {
                          return fetch(A.formats[0].src)
                            ...
                            .then(function(e) {
                              return (
                                A.fontFace.setProperty('src', 'url("'.concat(e, '")')),
                                '@font-face {'.concat(A.fontFace.cssText, ' ')
                              );
                            });
                        })
                      );
                ...
                value: function(A) {
                  ...
                  if (A instanceof HTMLIFrameElement) {
                    ...
                    var B = O(A, 0, 0),
                      ...
                      o = B.height;
                    return (
                      (this.resourceLoader.cache[n] = Zt(A, this.options)
                        .then(function(A) {
                          return e.renderer(
                            A,
                            {
                            ...
                            (B.onload = function() {
                              ...
                              r.parentNode &&
                                r.parentNode.replaceChild(
                                  b(A.ownerDocument.defaultView.getComputedStyle(A), B),
                                  r
                                );
                          });
                        })),
              ...
              },
              {
                ...
                value: function(A) {
                  ...
                  this.referenceElement === A &&
                    ...
                    e instanceof t.HTMLBodyElement && Gt(e);
                  for (
                    var s = (function(A, e) {
                        if (!A || !A.counterReset || 'none' === A.counterReset) return [];
                        for (
                          var t = [], r = A.counterReset.split(/\s*,\s*/), n = r.length, B = 0;
                          B < n;
                          B++
                        ) {
                        ...
                        return t;
                      })(r, this.pseudoContentData),
                      o = Dt(A, n, this.pseudoContentData),
                      a = A.firstChild;
                    a;
                    a = a.nextSibling
                  )
                    (a.nodeType === Node.ELEMENT_NODE &&
                      ('SCRIPT' === a.nodeName ||
                        a.hasAttribute('data-html2canvas-ignore') ||
                        ('function' == typeof this.options.ignoreElements &&
                          this.options.ignoreElements(a)))) ||
                      (this.copyStyles && 'STYLE' === a.nodeName) ||
                      e.appendChild(this.cloneNode(a));
                  var i = Dt(A, B, this.pseudoContentData);
                  if (
                    ((function(A, e) {
                      for (var t = A.length, r = 0; r < t; r++) e.counters[A[r]].pop();
                    })(s, this.pseudoContentData),
                    A instanceof t.HTMLElement && e instanceof t.HTMLElement)
                  )
                    switch (
                      (n && this.inlineAllImages(kt(A, e, n, o, Jt)),
                      B && this.inlineAllImages(kt(A, e, B, i, Rt)),
                      !r || !this.copyStyles || A instanceof HTMLIFrameElement || b(r, e),
        ...
        kt = function(A, e, t, r, n) {
          if (
              ...
              for (var s = r.length, o = 0; o < s; o++) {
                ...
                switch (a.type) {
                  case 1:
                    ...
                    (i.src = sA('url('.concat(a.value, ')'))[0].args[0]),
                      (i.style.opacity = '1'),
                      B.appendChild(i);
                    break;
                  case 0:
            ...
            return (
              (B.className = ''.concat(_t, ' ').concat(Pt)),
              (e.className += ' '.concat(n === Jt ? _t : Pt)),
              n === Jt ? e.insertBefore(B, e.firstChild) : e.appendChild(B),
              B
            );
          }
        },
      ...
      var er = function A(e, t, r) {
        ...
        return (t.foreignObjectRendering
          ? _A.SUPPORT_FOREIGNOBJECT_DRAWING
          : Promise.resolve(!1)
        ).then(function(s) {
          return s
            ? (function(A) {
                return A.inlineFonts(n)
                  .then(function() {
            ...
            : (function(A, e, t, r, n, B) {
                ...
                return $t(A, e).then(function(n) {
                  var B = n.contentWindow,
                    ...
                    c = Ar(n).then(function() {
                      ...
                      return s.clonedReferenceElement instanceof B.HTMLElement ||
                        s.clonedReferenceElement instanceof A.defaultView.HTMLElement ||
                  ...
                  return (
                        ...
                        (function(A) {
                          ...
                          return (
                            A &&
                              ...
                              A.publicId && (e += '"'.concat(A.publicId, '"')),
                              A.systemId && (e += '"'.concat(A.systemId, '"')),
                              (e += '>')),
                            e
                          );
                        })(document.doctype),
                    ...
                    i.replaceChild(i.adoptNode(s.documentElement), i.documentElement),
                    i.close(),
                    c
                  );
                });
                ...
                var e = (function(A, e) {
                      ...
                      (function A(e, t, r, n, B) {
                        for (var s, o = e.firstChild; o; o = s) {
                          ...
                          if (
                            o instanceof a.Text ||
                            o instanceof Text ||
                            (a.parent && o instanceof a.parent.Text)
                          )
                            o.data.trim().length > 0 && t.childNodes.push(jA.fromTextNode(o, t));
                          else if (
                            o instanceof a.HTMLElement ||
                            o instanceof HTMLElement ||
                            (a.parent && o instanceof a.parent.HTMLElement)
                          ) {
                            if (-1 === xe.indexOf(o.nodeName)) {
                              ...
                              if (i.isVisible()) {
                                'INPUT' === o.tagName
                                  ...
                                  ? Fe(o, i)
                                  : i.style.listStyle &&
                                    -1 !== i.style.listStyle.listStyleType &&
                                    Ee(o, i, n);
                                var c = 'TEXTAREA' !== o.tagName,
                                  Q = Ve(i, o);
                                if (Q || ke(i)) {
                                  var l =
                                      Q || i.isPositioned() ? r.getRealParentStackingContext() : r,
                                    w = new Oe(i, l, Q);
                            ...
                            o instanceof a.SVGSVGElement ||
                            o instanceof SVGSVGElement ||
                            (a.parent && o instanceof a.parent.SVGSVGElement)
                          ) {
                  ...
                  c = s.ownerDocument;
                return (
                  a === i.container.style.background.backgroundColor &&
                    (i.container.style.background.backgroundColor = F),
                  o.ready().then(function(A) {
                    ...
                    return (
                      !0 === t.removeContainer && B.parentNode && B.parentNode.removeChild(B), h
                    );
                  })
                );
              });
